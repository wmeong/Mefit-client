  ...
  <v-container class="personal-color-container">
    ...
    <div class="palette-section" v-if="palette.length">
      ...
      <div class="palette-row">
        <v-carousel hide-delimiters class="custom-carousel" height="160px">
          <v-carousel-item
...
export default {
  ...
  computed: {
    ...
    toneDescription() {
      const descriptions = {
        "봄웜 라이트":
          "부드럽고 밝은 파스텔 톤이 특징! 노란빛이 감도는 따뜻한 색조가 많아요.",
        "봄웜 브라이트":
          "선명하고 활기찬 색감이 많은 톤! 대비가 높고 생기 있는 색상이 어울려요.",
        "봄웜 트루":
          "노란기가 강한 클래식한 봄웜 계열 색상이에요. 따뜻하고 소프트한 느낌!",
        "여름쿨 라이트":
          "쿨톤이지만 밝고 부드러운 파스텔 계열이 어울리는 타입! 연한 블루, 핑크 계열이 많아요.",
        "여름쿨 브라이트":
          "여름쿨 계열 중에서도 화사하고 쨍한 색상이 어울리는 타입.",
        "여름쿨 뮤트":
          "채도가 낮고 살짝 흐릿한 색상이 잘 어울리는 타입! 부드럽고 분위기 있는 색조가 많아요.",
        "가을웜 뮤트":
          "톤 다운된 가을색이 특징! 베이지, 브라운, 카키 같은 자연색 계열이 많아요.",
        "가을웜 스트롱":
          "가을웜 중에서도 짙고 깊은 색감이 강한 타입. 골드, 오렌지, 녹색 등이 어울려요.",
        "가을웜 딥":
          "가장 어두운 가을 계열. 깊고 진한 색이 주를 이룸. 어두운 브라운, 레드 계열이 많음.",
        "겨울쿨 브라이트":
          "겨울쿨 중에서도 화사하고 쨍한 컬러가 잘 어울리는 타입! 선명한 블루, 레드 계열이 많아요.",
        "겨울쿨 스트롱":
          "대비가 강한 컬러들이 어울리는 톤! 블랙&화이트도 강하게 받쳐주는 느낌.",
        "겨울쿨 다크":
          "차분하고 어두운 쿨톤 계열이 어울림. 블루 계열의 다크 톤이 주를 이룸.",
      };
      return (
        descriptions[this.colorName] || "이 톤에 대한 설명이 준비 중입니다."
      );
    },
  },
  methods: {
...
.color-label {
  ...
  color: #333; /* 기존보다 더 진한 색상 */
  font-size: 12px; /* 가독성 좋은 크기로 조정 */
  font-weight: bold;
  padding: 6px;
